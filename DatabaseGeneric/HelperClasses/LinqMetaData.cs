...
namespace Data.Linq
{
	...
	public partial class LinqMetaData: ILinqMetaData
	{
		...
		{
			switch((Data.EntityType)typeOfEntity)
			{
		...
		/// <summary>returns the datasource to use in a Linq query when targeting TravelEntity instances in the database.</summary>
		public DataSource2<TravelEntity> Travel {	get { return new DataSource2<TravelEntity>(this.AdapterToUse, new ElementCreator(), this.CustomFunctionMappings, this.ContextToUse); } }
